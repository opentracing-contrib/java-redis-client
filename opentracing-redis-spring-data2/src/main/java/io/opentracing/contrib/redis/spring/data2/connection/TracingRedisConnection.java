...
public class TracingRedisConnection implements RedisConnection {
  ...
  public void rename(byte[] sourceKey, byte[] targetKey) {
    helper.doInScope(RedisCommand.RENAME, sourceKey, () -> connection.rename(sourceKey, targetKey));
  }

  @Override
  public Boolean renameNX(byte[] sourceKey, byte[] targetKey) {
    return helper.doInScope(RedisCommand.RENAMENX, sourceKey,
  ...
  public ValueEncoding encodingOf(byte[] key) {
    return helper.doInScope(RedisCommand.ENCODING, key, () -> connection.encodingOf(key));
  }

  @Override
  public Duration idletime(byte[] key) {
    return helper.doInScope(RedisCommand.IDLETIME, key, () -> connection.idletime(key));
  }

  @Override
  public Long refcount(byte[] key) {
    return helper.doInScope(RedisCommand.REFCOUNT, key, () -> connection.refcount(key));
  }
  ...
  public Boolean set(byte[] key, byte[] value) {
    return helper.doInScope(RedisCommand.SET, key, () -> connection.set(key, value));
  }
  ...
  public Boolean setEx(byte[] key, long seconds, byte[] value) {
    return helper.doInScope(RedisCommand.SETEX, key, () -> connection.setEx(key, seconds, value));
  }
  ...
  public Boolean mSet(Map<byte[], byte[]> tuple) {
    return helper.doInScope(RedisCommand.MSET, () -> connection.mSet(tuple));
  }
  ...
  public Long bitPos(byte[] key, boolean bit, org.springframework.data.domain.Range<Long> range) {
    return helper.doInScope(RedisCommand.BITPOS, key, () -> connection.bitPos(key, bit, range));
  }
  ...
  public List<byte[]> sPop(byte[] key, long count) {
    return helper.doInScope(RedisCommand.SPOP, key, () -> connection.sPop(key, count));
  }
  ...
  public Long zUnionStore(byte[] destKey, byte[]... sets) {
    return helper.doInScope(RedisCommand.ZUNIONSTORE, () -> connection.zUnionStore(destKey, sets));
  }
  ...
  public Long hStrLen(byte[] key, byte[] field) {
    return helper.doInScope(RedisCommand.HSTRLEN, key, () -> connection.hStrLen(key, field));
  }
