...
public class TracingRedisClusterConnectionTest extends TracingRedisConnectionTest {
  ...
  /**
   * Make sure we get a {@link RedisConnectionFactory} that returns a tracing cluster connection.
   * Without our Aspect, this would return a regular {@link RedisClusterConnection}.
   */
  @Override
  @Test
